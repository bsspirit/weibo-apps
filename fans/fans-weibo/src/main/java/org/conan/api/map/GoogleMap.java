...
public class GoogleMap {
    ...
    public static Map<String, String> address2point(String address) {
        ...
        NameValuePair[] data = { new NameValuePair("q", address), new NameValuePair("output", "json"), new NameValuePair("sensor", "false"), new NameValuePair("aisle", "229"), new NameValuePair("key", "bsspirit") };
    ...
    public static void main(String[] args) {
        System.out.println(address2point("北京 朝阳"));
        System.out.println(address2point("北京朝阳"));
        System.out.println(address2point("北京朝阳区"));
    }
}
