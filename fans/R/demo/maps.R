...
plot(x,col = "white", ylim = c(18, 54));
#map("china", col = "darkgray", ylim = c(18, 54)) #, panel.first = grid())
points(dat$jd, dat$wd, pch = 19, cex=0.5, col='blue')
#pointLabel(dat$jd, dat$wd, dat[, 1],cex=0.6, allowSmallOverlap=FALSE,,col = rgb(0, 0, 0, 0.7));
#text(dat$jd, dat$wd, dat[, 1], cex = 0.6, col = rgb(0, 0, 0, 0.7)
    #,pos=rep(1,34))
